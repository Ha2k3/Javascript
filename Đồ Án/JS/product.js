...
var product = [{							
    ...
    img: 'https://file.hstatic.net/200000503583/file/ao-dai-truyen-thong__25__03c9cca569174b71a37cf520f19efdd1_grande.jpg',							
    price: 122000,							
    },							
    {							
    id: 'SP2',							
...
function listLocal(){
    ...
    for(var i in product){
        ...
        listProduct += '<img class="card-img-top" scr="img/' + data.img +'">';
        ...
        listProduct += '<button class="btn btn-secondary" data-toggle="modal" data-target="#proDetails" onclick="proDetail('+i+')">Detail</button>';
        listProduct += '<span class="text-center add-to-cart btn">';
        listProduct += '<button class="btn btn success">' + '<i class="fa fa-cart-plus"> </i>' + '</button> </span>';
        document.getElementById("banchay").innerHTML+=listProduct;
    }
    Save();
}
